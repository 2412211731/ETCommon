 ...
 */
package com.example.mycommon.utils.netstate;

import java.util.ArrayList;
import com.example.mycommon.utils.log.AppLogger;
import android.content.BroadcastReceiver;
import android.content.Context;
import android.content.Intent;
import android.content.IntentFilter;
import com.example.mycommon.utils.netstate.NetWorkUtil.netType;
...
public class NetworkStateReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		{
			AppLogger.i(NetworkStateReceiver.this, "网络状态改变.");
			if (!NetWorkUtil.isNetworkAvailable(context))
			{
				AppLogger.i(NetworkStateReceiver.this, "没有网络连接.");
				networkAvailable = false;
			} else
			{
				AppLogger.i(NetworkStateReceiver.this, "网络连接成功.");
	...
	public static void unRegisterNetworkStateReceiver(Context mContext)
	{
		if (receiver != null)
		{
			...
			} catch (Exception e)
			{
				...
				AppLogger.d("TANetworkStateReceiver", e.getMessage());
			}
		}
